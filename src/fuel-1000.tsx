...
const FuelConsumption1000 = () => {
  // Generate data with 1000 points using consistent colors for all curves
  const plotData = useMemo(() => {
    // Configuration constants - 1000 points per curve
    ...
    return [
      // Temperate Climate - Style 1 with shared pressure gradient
      {
        ...
        marker: {
          size: 4, // Smaller markers for better visibility with 1000 points
  ...
  const plotLayout = {
    title: {
      text: "Fuel Consumption vs. Height - 5 Line Styles with Same Pressure Scale (1000 Points)",
    },
    xaxis: {
      title: {
    ...
    margin: {
      r: 250, // Increased margin for larger legend with 5 entries
    },
  };
  ...
  console.log(
    ...
    plotData.length,
    "traces (5 curves with different line styles) using consistent colors and 1000 points per curve"
  );
  return (
