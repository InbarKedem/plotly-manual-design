...
const HeightTemperatureSimplePlot = () => {
  // Generate data with 1K points for fuel consumption analysis
  const plotData = useMemo(() => {
    // Configuration constants - increased to 1K points
    const NUM_POINTS = 1000; // Increased from 100 to 1000 points
    ...
    // Return the plot data configuration for fuel consumption analysis
    return [
      {
  ...
  const plotLayout = {
    title: {
      text: "Fuel Consumption vs. Height - Climate Analysis (1K points per curve)",
    },
    xaxis: {
      title: {
  ...
  console.log(
    ...
    plotData.length,
    "traces and 1000 points per curve - Fuel Consumption Analysis"
  );
  return (
    <Plot
      data={plotData}
